...
public class Thread_0 extends Thread {
	...
	public Thread_0(Barrier barrier) {
	...
	public void run() {
		barrier.masterSync(2);
		long c0, c1;
		long cal = 0, total = 0, Ccal = 0;
...
//				System.out.println("Thread0 stageNum: " + stageNum);
		...
		System.out.println("thread_0: cal_time, " + cal + " total_time, " + total + "\n");
		try {
			fos = new FileOutputStream("thread 0's CALRATIO.txt");
